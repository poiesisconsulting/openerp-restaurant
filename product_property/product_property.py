...
class ProductProperty(osv.osv):
    ...
    _columns = {
              ...
              'product_attribute_ids': fields.one2many('product.product.property.rel', 'property_id', 'Product'),
...
class ProductProductPropertyRel(osv.osv):
    _name = 'product.product.property.rel'
    _columns = {
