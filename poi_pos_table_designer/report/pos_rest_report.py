...
class pos_rest_report(osv.osv):
    _name = "report.pos.rest"
    _description = "Restaurant Statistics"
    _auto = False
    _columns = {
        ...
        'parent_categ_id':fields.many2one('product.category', 'Category', readonly=True),
